...
const types = [
  {
    ...
    features: ["Цена от договорной", "Большой выбор размеров"],
    href: "/used-pallets",
  },
  {
    icon: "📦",
    ...
    features: ["Сертифицированная древесина", "Размер 1200×1000"],
    href: "/pallets",
  },
  {
    icon: "⚙",
    ...
    features: ["Любые размеры и форма", "Срок от 5 рабочих дней"],
    href: "/ctaunder",
  },
];
